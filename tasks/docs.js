...
gulp.task('docs-build-demos', gulp.series(() => {
  return gulp.src(`./${config.temp.path}/${config.docs.nodeModulesPath}/${config.bundle.scope}/*/${config.demos.path}/**/*.html`, { base: './' })
...
gulp.task('docs-build-demo-imports', () => {
  ...
  return gulp.src(`${config.temp.path}/${config.docs.nodeModulesPath}/${config.bundle.scope}/*/${config.demos.path}/${config.demos.importsImporterFilename}`)
    .pipe(foreach(function(stream, file) {
...
gulp.task('docs-generate', () => {
  ...
  const buildConfig = {
    ...
    'fragments': [],
    'sources': [
      `${config.docs.nodeModulesPath}/${config.bundle.scope}/*/${config.demos.path}/**`,
      `${config.docs.nodeModulesPath}/${config.bundle.scope}/*/${config.dist.path}/**`
    ],
    'extraDependencies': [
